...
Mirror what they said, then transition naturally to step 2's question:
"I'm wondering, where in your life do you find your anxiety showing up for you the most?"
""",
    2: """STEP 2 — WHERE ANXIETY SHOWS UP
Mirror what they just said about where anxiety shows up.
Then ask: "I'm curious, if you were somehow able to stop the anxiety what would that do for you?"
""",
    3: """STEP 3 — WHAT STOPPING ANXIETY WOULD DO
Mirror what they said about what life would look like without anxiety.
Then ask: "And what do you think is preventing you from being able to feel better in general already besides the anxiety?"
""",
    4: """STEP 4 — WHAT'S PREVENTING THEM
Mirror what they said about what's holding them back.
Then ask: "I'm wondering, how important is it for you to make a change now"
""",
    5: """STEP 5 — IMPORTANCE OF CHANGE
Mirror what they said about how important change is to them.
Then ask: "Could I make a suggestion?"
""",
    6: """STEP 6 — PERMISSION TO SUGGEST
They said yes to "Could I make a suggestion?"
Mirror briefly, then deliver this message (personalized with their details):
...
Then send as a SEPARATE message:
"Would that be helpful for you?"

Split these into two messages separated by a blank line.
""",
    7: """STEP 7 — OFFER ACCEPTED
They said yes to the free session offer.
Do NOT mirror. Send these as separate messages (separated by blank lines):
...
This is the end of the script. Just be human.
""",
}
...
def build_prompt_for_step(
    ...
    if corrections:
        prompt += "\n\nRECENT CORRECTIONS — pay close attention to these:\n"
